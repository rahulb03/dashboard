...
/**
 * @typedef {Object} DataTableToolbarProps
 * @property {import('@tanstack/react-table').Table} table - The table instance
 */

/**
 * @param {DataTableToolbarProps & React.ComponentProps<'div'>} props
 */
...
/**
 * @typedef {Object} DataTableToolbarFilterProps
 * @property {import('@tanstack/react-table').Column} column - The column instance
 */

/**
 * @param {DataTableToolbarFilterProps} props
 */
