...
| :------------------------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Signup / Signin      | Simple authentication system with email/password login and simulated GitHub authentication. Easy to extend with real authentication providers. |
